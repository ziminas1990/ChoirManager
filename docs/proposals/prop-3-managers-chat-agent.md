# Proposal 3: Managers Chat Agent

The Managers' Chat Agent is an AI agent that keeps all messages from the managers' chat from the last `N` days in its context. Each message in the context includes the following data:
